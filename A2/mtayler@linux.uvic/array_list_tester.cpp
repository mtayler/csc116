/* array_list_tester.cpp

   CSC 116 Assignment 2 (Fall 2015)

   Tester for the array_list class.
*/
...
string convert_to_string(array_list &l)
{
	stringstream s;
	s << l;
...
bool check_sorted(array_list& l)
{
	if (l.size() == 0)
		return true;
